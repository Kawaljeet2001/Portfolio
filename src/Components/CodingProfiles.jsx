...
const CodingProfiles = () => {
  return (
    <div
      className="flex flex-col items-start pt-4 pb-8 px-8 w-full rounded-lg mt-10"
      style={{
        boxShadow:
    ...
    >
      ...
      <div className="flex items-center flex-wrap mt-8 w-fulljustify-center">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-start justify-start mx-0 my-3 md:my-0 md:mx-4 "
        >
          <SiLeetcode className="text-5xl text-gray-400" />
          <div className="flex flex-col ml-2">
            <h3 className="text-lightGreen ">Leetcode</h3>
            <p className="text-gray-500 text-sm">
              Solved <span className="text-white">250+</span> problems
            </p>
          </div>
        </a>
        <a
